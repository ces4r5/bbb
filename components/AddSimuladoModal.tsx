...
import { X, Plus, FileText, Calendar, Clock, Target } from 'lucide-react-native';
...
export function AddSimuladoModal({ visible, onClose, subjects, onSave }: AddSimuladoModalProps) {
